...
const SectionFive: React.FC = () => (
    <section className="section-five bg-sky-blue 2xl:h-[1900px] xl:h-[1750px]"> { /* Manually setting the height like this seems like a poor solution. Did this to avoid empty space down the bottom of webpage due to translate-y */}
        <Inner>
            <SeasonSection seasonImage={backgroundImg} seasonImageMobile={backgroundImgMobile} seasonText="Summer">
                    <div className="flex xl:flex-row flex-col justify-between xl:gap-[56px]">
                  ...
                  transition={{ duration: 0.5, delay: 0.4, ease: 'easeOut' }}>
                            ...
                            <div className="overflow-hidden rounded-[20px] hidden xl:block xl:w-auto w-full" >
                                <Image src={image16} alt="Snorkelling" className="rounded-[20px] xl:w-auto w-full" data-scroll data-scroll-speed="-.05"  />
                            </div>
                        </div>
                        <div className="flex flex-col justify-between gap-[38px] xl:gap-[69px]">
                            <div className="overflow-hidden rounded-[20px] xl:w-auto w-full" >
                                <Image src={image15} alt="Hot air balloon" className="rounded-[20px] xl:w-auto w-full" data-scroll data-scroll-speed="-.05" />
                            </div>
                            <motion.div
                            ...
                            <div className="overflow-hidden rounded-[20px] block xl:hidden xl:w-auto w-full" >
                                <Image src={image16} alt="Snorkelling" className="rounded-[20px] xl:w-auto w-full" data-scroll data-scroll-speed="-.05"  />
                            </div>
                        </div>
                    </div>
                    <MotionImage src={image17} alt="bear cartoon" aria-label="bear" className="absolute 2xl:-right-[220px] 2xl:-bottom-[50px] -bottom-[40px] -right-[45px] xl:w-auto lg:w-[270px] w-[230px]"
