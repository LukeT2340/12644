        ...
        <Inner>
            <div className="relative flex flex-col items-center w-[100vw]">
                ...
                <div className='relative lg:px-[100px] lg:w-[600px] 2xl:w-[786px] bg-bright-orange text-center lg:text-[13px] lg:leading-[23px] xl: text-[14px] leading-[25px] 2xl: text-white py-[140px] lg:py-[130px] 2xl:py-[200px] z-10 px-[25px]'>
                    ...
                    <p className=' p-0'>{"Take your pick: Taiwan offers unique experiences for visitors year-round. If you’ve been before, you’ll find variety and new experiences in other seasons. And if you’re a first timer, you’ll discover more to Taiwan than you ever imagined."}</p>
                </div>
            </div>
        </Inner>
    )
